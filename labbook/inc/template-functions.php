...
if ( ! function_exists( 'labbook_revisions_available_for_post' ) ) :
	/**
	 * Check if revisions are enabled and available for a particular post.
	 *
	 * @param int|WP_Post|null $post Post ID or post object. Defaults to global $post.
	 * @return bool true if enabled and available, false otherwise.
	 */
	function labbook_revisions_available_for_post( $post = null ) {
		global $ssl_alp;
		...
		if ( empty( labbook_get_post_edit_count( $post ) ) ) {
...
if ( ! function_exists( 'labbook_references_available_for_post' ) ) :
	/**
	 * Check if cross-references are enabled and available for a particular post.
	 *
	 * @param int|WP_Post|null $post Post ID or post object. Defaults to global $post.
	 * @return bool true if enabled and available, false otherwise.
	 */
	function labbook_references_available_for_post( $post = null ) {
		global $ssl_alp;
